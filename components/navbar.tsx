      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            {navLinks
              .filter((link) => {
                // Hide download link based on user role and page context
                if (link.name === "Download" && shouldHideDownloadLink()) {
                  return false
                }
                return true
              })
            ...
            {/* Theme Toggle */}
            <ModernThemeToggle isHomePage={isHomePage} isScrolled={scrolled} />
